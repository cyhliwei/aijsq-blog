...
public class SeoInjectService {
    private static final String KEYWORDS = "AI技术圈,开源社区,java,springboot,IT,程序员,开发者,mysql,redis,Java基础,多线程,JVM,虚拟机,数据库,MySQL,Spring,Redis,MyBatis,系统设计,分布式,RPC,高可用,高并发,AI技术圈";
    private static final String DES = "AI技术圈,一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、MongoDB、Docker、RabbitMQ 等技术栈实现的社区系统，采用主流的互联网技术架构、全新的UI设计、支持一键源码部署，拥有完整的文章&教程发布/搜索/评论/统计流程等，代码完全开源，没有任何二次封装，是一个非常适合二次开发/实战的现代化社区项目。学编程，就上AI技术圈";
    ...
    public void initUserSeo(UserHomeVo user) {
        ...
        String title = "AI技术圈 | " + user.getUserHome().getUserName() + " 的主页";
        list.add(new SeoTagVo("og:title", title));
    ...
    public Seo defaultSeo() {
        Seo seo = initBasicSeoTag();
        List<SeoTagVo> list = seo.getOgp();
        list.add(new SeoTagVo("og:title", "AI技术圈"));
        ...
        list.add(new SeoTagVo("article:author", "AI技术圈"));

        list.add(new SeoTagVo("author", "AI技术圈"));
        list.add(new SeoTagVo("title", "AI技术圈"));
    ...
    public void initArticleSeo(ColumnArticlesDTO detail, Long articleId) {
        Seo seo = initBasicSeoTag();
        List<SeoTagVo> list = seo.getOgp();
        Map<String, Object> jsonLd = seo.getJsonLd();
